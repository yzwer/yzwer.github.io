...
def create_draft(token, title, content, thumb_media_id=None, source_url=''):
    article = {
        "title": title,
        "author": "OpenClaw",
        "digest": title[:50],
...
# 创建新草稿（不带封面，先测试）
print("正在创建新草稿...")
result = create_draft(token, new_title, content, source_url="https://www.youtube.com/watch?v=ExxZ-ug-LFs")
