...
<head>
    ...
    <title>3.2亿人「困」在算法里：灵活就业繁荣背后的真相</title>
    <style>
...
out_path = r"C:\Users\11132\.qclaw\workspace-yw3plsutb1jupnif\youtube_videos\N82hizSHRpo_wechat_article.html"
with open(out_path, "w", encoding="utf-8") as f:
    f.write(html)

size = os.path.getsize(out_path)
print("Done! Path:", out_path)
