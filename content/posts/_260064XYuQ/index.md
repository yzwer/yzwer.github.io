...
<div class="c">
<div class="lead">
5月29日 A股4大指數全縣下跌截至收盤 戶指跌了0.73%深圳城址跌了1.81%充業板子跌了2.1%科創宗旨跌得最慘跌了4.77%全市場超過3800支股票再跌基本上一篇率但市就在這篇率海里有一個版塊卻逆施爆發了那就是9位大長的房地產股A股這邊陽光股份 鄉江控股直接漲停萬科綠地一度出擊漲停保麗發展 招商舌口冰江集團 金地集團也跟著漲港股那邊航行更誇張閉桂園盤中漲潮40%容創中國一度漲潮20%續揮集團 失貿集團正容地產漲幅均超10%聯籠湖集團 越秀地產華潤之地這些相對穩健的房企也錄得超過3%的漲幅那麼地產股這一波不切而至的爆發航行到底是什麼因素出發的市場認為背後有兩方面的原因我們一個一個來講第一...
</div>
<!-- 1 -->
</div>
...
<div class="c">
<p>5月29日 A股4大指數全縣下跌截至收盤 戶指跌了0.73%深圳城址跌了1.81%充業板子跌了2.1%科創宗旨跌得最慘跌...</p>
<div class="dv"></div>
['<p>5月29日 A股4大指數全縣下跌</p>', '<p>截至收盤 戶指跌了0.73%</p>', '<p>深圳城址跌了1.81%</p>', '<p>充業板子跌了2.1%</p>', '<p>科創宗旨跌得最慘</p>', '<p>跌了4.77%</p>', '<p>全市場超過3800支股票再跌</p>', '<p>基本上一篇率</p>', '<p>但市就在這篇率海里</p>', '<p>有一個版塊卻逆施爆發了</p>', '<p>那就是9位大長的房地產股</p>', '<p>A股這邊</p>', '<p>陽光股份 鄉江控股直接漲停</p>', '<p>萬科綠地一度出擊漲停</p>', '<p>保麗發展 招商舌口</p>', '<p>冰江集團 金地集團也跟著漲</p>', '<p>港股那邊航行更誇張</p>', '<p>閉桂園盤中漲潮40%</p>', '<p>容創中國一度漲潮20%</p>', '<p>續揮集團 失貿集團</p>', '<p>正容地產漲幅均超10%</p>', '<p>聯籠湖集團 越秀地產</p>', '<p>華潤之地這些相對穩健的房企</p>', '<p>也錄得超過3%的漲幅</p>', '<p>那麼地產股這一波不切而至的爆發航行</p>', '<p>到底是什麼因素出發的</p>', '<p>市場認為背後有兩方面的原因</p>', '<p>我們一個一個來講</p>', '<p>第一個主要原因是中國國務院</p>', '<p>剛發布了城市更新15個規劃</p>', '<p>這份有關房地產的頂層文件</p>', '<p>拆開來看</p>', '<p>其實就講了三件事</p>', '<p>給錢 給項目 給回款渠道</p>', '<p>給錢 也就是放開專項站</p>', '<p>以前地方專項站有嚴格限制</p>', '<p>只能做配套貸款</p>', '<p>不能直接充當項目啟動資金</p>', '<p>這就帶來一個很現實的問題</p>', '<p>改造城中村 翻新老舊小區</p>', '<p>項目前期需要一大筆啟動資金</p>', '<p>但地方政府拿不出來</p>', '<p>銀行也不願意在項目還沒動工的時候</p>', '<p>就大規模放待</p>', '<p>結果就是大量改造工程只能隔止</p>', '<p>等錢 等錢 一直等錢</p>', '<p>項目就這麼拖著</p>', '<p>但現在新規明確</p>', '<p>專項站可以直接充當項目資本金</p>', '<p>那就完全不一樣了</p>']
<div class="dv"></div>
<div class="ft">
